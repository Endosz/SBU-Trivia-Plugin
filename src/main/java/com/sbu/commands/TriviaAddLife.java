...
public class TriviaAddLife implements CommandExecutor {
    @Override
        ...
        if(commandSender.isOp()){
            ...
            if(player!=null){
                ...
                if(objectiveLives!=null){
                    ...
                    commandSender.sendMessage("Successfully added score to "+ChatColor.AQUA+player.getName()+ChatColor.RESET+".");
                }else{
